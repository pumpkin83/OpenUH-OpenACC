...
void __accr_get_device_addr(void* pHostAddr, void** pDeviceAddr, unsigned int istart, unsigned int isize)
{
	int key, map_length;
    param_t *param;
