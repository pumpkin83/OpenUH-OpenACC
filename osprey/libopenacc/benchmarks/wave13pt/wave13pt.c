...
{
  //#pragma acc kernels param(w0,w1,w2,ns,ny,nx,c0,c1,c2)
  #pragma acc kernels
  {
	//#pragma acc loop independent vector(2) private(k,j,i)
	#pragma acc loop independent gang(128)
	//#pragma acc loop independent gang(4) vector(2)
	for (k = 2; k < ns - 2; k++)
	{
