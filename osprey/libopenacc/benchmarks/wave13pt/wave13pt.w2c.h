...
extern int wave13pt(int, int, int, const double, const double, const double, double *, double *, double *);
...
static void __accrg_wave13pt_1_1(unsigned long long, unsigned long long);
