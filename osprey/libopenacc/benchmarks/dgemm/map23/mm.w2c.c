/*******************************************************
 * C file translated from WHIRL Wed Aug 28 23:44:23 2013
 *******************************************************/
  ...
  int n)
{
  ...
  __accr_set_gang_num_y(8192);
  __accr_set_gang_num_x(64);
  ...
  __accr_launchkernel("__accrg_iter_matmul_1_1\0", "mm.w2c.ptx\0", -2);
  _1794 :;
