...
int main()
{
	...
	__accr_memin_h2d(A, dev_A, size);
	__accr_memin_h2d(B, dev_B, size);

	__accr_push_kernel_param_pointer(dev_A, ACC_KDATA_UINT8);
	__accr_push_kernel_param_pointer(dev_B, ACC_KDATA_UINT8);
	__accr_push_kernel_param_pointer(dev_C, ACC_KDATA_UINT8);
	...
	__accr_memout_d2h(dev_C, C, size);
	__accr_cleanup();
